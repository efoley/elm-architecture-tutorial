...
type alias FName = String

type Expr = Const Float
          | Ref Pos
          | Range Pos Pos
          | Fun1 FName Expr
          | Fun2 FName Expr Expr
...
fname : Parser FName
fname = choice [Parser.token "sum"]

fun1 : Parser Expr
fun1 = map Fun1 fname |> andMap (Parser.parenthesized expr)

fun2 : Parser Expr
fun2 = map Fun2 fname |> andMap expr |> andMap expr

expr : Parser Expr
expr = choice [val, range, ref, fun1, fun2]
